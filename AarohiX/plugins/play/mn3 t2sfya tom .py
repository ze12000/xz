...
@app.on_message(f & filters.create(is_sudoer))
...
@app.on_message(f & filters.channel & filters.create(is_sudoer))
...
@app.on_message(f & filters.group & filters.create(is_sudoer))
async def promote_by_id(Client, message):
    chat_id = message.chat.id
    text = message.text.split()
...
@app.on_message(filters.text & ~filters.create(is_sudoer))
...
@app.on_message(filters.regex("قفل المنشن") & filters.create(is_sudoer))
...
@app.on_message(filters.regex("فتح المنشن") & filters.create(is_sudoer))
...
@app.on_message(filters.text & ~filters.create(is_sudoer) & filters.create(lambda _, __, message: mention_locked))
async def delete_mention(Client, message):
    if "@" in message.text:
        await message.delete()


@app.on_message(filters.regex("قفل الفيديو") & filters.create(is_sudoer))
...
@app.on_message(filters.regex("فتح الفيديو") & filters.create(is_sudoer))
...
@app.on_message(filters.video & ~filters.create(is_sudoer) & filters.create(lambda _, __, message: video_locked))
async def delete_video(Client, message):
    await message.delete()


@app.on_message(filters.regex("قفل الروابط") & filters.create(is_sudoer))
...
@app.on_message(filters.regex("فتح الروابط") & filters.create(is_sudoer))
...
@app.on_message(filters.text & ~filters.create(is_sudoer) & filters.create(lambda _, __, message: link_locked))
async def delete_links(Client, message):
    if any(entity.type == "text_link" for entity in message.entities):
        await message.delete()


@app.on_message(filters.regex("قفل التوجيه") & filters.create(is_sudoer))
...
@app.on_message(filters.regex("فتح التوجيه") & filters.create(is_sudoer))
...
@app.on_message(filters.forwarded & filters.create(lambda _, __, message: forward_locked))
async def delete_forwarded_messages(Client, message):
    await message.delete()


@app.on_message(filters.regex("قفل الملصقات") & filters.create(is_sudoer))
...
@app.on_message(filters.regex("فتح الملصقات") & filters.create(is_sudoer))
...
@app.on_message(filters.sticker & ~filters.create(is_sudoer) & filters.create(lambda _, __, message: sticker_locked))
async def delete_sticker(Client, message):
    await message.delete()


@app.on_message(filters.regex("قفل الردود") & filters.create(is_sudoer))
...
@app.on_message(filters.regex("فتح الردود") & filters.create(is_sudoer))
...
@app.on_message(filters.reply & ~filters.create(is_sudoer) & filters.create(lambda _, __, message: reply_locked))
async def delete_reply(Client, message):
    await message.delete()


@app.on_message(filters.regex("قفل الصور") & filters.create(is_sudoer))
...
@app.on_message(filters.regex("فتح الصور") & filters.create(is_sudoer))
...
@app.on_message(filters.photo & ~filters.create(is_sudoer) & filters.create(lambda _, __, message: photo_locked))
async def delete_photo(Client, message):
    await message.delete()


@app.on_message(filters.regex("قفل الدردشة") & filters.create(is_sudoer))
...
@app.on_message(filters.regex("فتح الدردشة") & filters.create(is_sudoer))
